...
def check(Aadhar_Num):

    url = "https://kduvv091s4.execute-api.us-east-1.amazonaws.com/PlasmaDonor/getaadhardata?Aadhar_Num="+Aadhar_Num
...
def register():
    ...
    print(x)
    params = "&Aadhar_Num="+x[0]+"&Bloodgroup="+x[1]+"&city="+x[2]+"&email="+x[3]+"&name="+x[4]+"&password="+x[5]+"&Phone="+x[6]
    
    if('errorType' in check(x[0])):
    
        url = "https://kduvv091s4.execute-api.us-east-1.amazonaws.com/PlasmaDonor/donorregister?"+params
...
def stats():
    ...
    url = "https://kduvv091s4.execute-api.us-east-1.amazonaws.com/PlasmaDonor/donotcount"
    response = requests.get(url)
    r = response.json()
    print(r)
...
def requested():
    ...
    url = "https://kduvv091s4.execute-api.us-east-1.amazonaws.com/PlasmaDonor/donor?Bloodgroup="+bloodgrp
    status = requests.request("GET",url)
    a=status.json()
